  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        behaviour: 'web',
        androidClientId:
          '250737091712-ong7m9g1svhsimop2eg1irl4bjgeme4h.apps.googleusercontent.com',
        iosClientId:
          '250737091712-jg7ecdedr2qnk4q317pl2cocub2ovu15.apps.googleusercontent.com',
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={this.signInWithGoogleAsync} style={styles.loginBox}>
        <Image style={styles.loginIcon} source={require('../assets/google_icon.png')} />
